...
When writing issue descriptions or comments, follow the ticket-linking rules in `skills/paperclip/references/comment-style.md`.
...
Read these only when the specific workflow is needed:

- **Comment and link formatting**: `skills/paperclip/references/comment-style.md`
- **Planning and issue documents**: `skills/paperclip/references/planning.md`
- **CEO/Manager workflows** (project setup, OpenClaw, import/export): `skills/paperclip/references/ceo-workflows.md`
- **Company skills management**: `skills/paperclip/references/company-skills.md` (existing)
- **Full API reference**: `skills/paperclip/references/api-reference.md` (existing)
- **Self-test playbook**: `skills/paperclip/references/self-test.md`
- **Agent instructions path**: `skills/paperclip/references/instructions-path.md`
